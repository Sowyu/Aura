/*
 * @adguard/scriptlets v2.3.1 (https://github.com/AdguardTeam/Scriptlets)
 * Copyright (c) AdGuard Software Ltd. Licensed GPL-3.0.
 *
 * Vendored verbatim from the npm tarball
 * https://registry.npmjs.org/@adguard/scriptlets/-/scriptlets-2.3.1.tgz
 * (dist/scriptlets/index.js), with the single trailing line
 * `export { scriptlets };` replaced by the global assignment below so the
 * bundle can be evaluated in a plain JavaScriptCore context.
 * Nothing else is modified. See LICENSE-adguard-scriptlets.txt.
 */
...
function trustedJsonSet(source, args) {
  ...
  function jsonSetter(e, t, r, n, a, o, i, s) {
    var {nativeStringify: l} = s;
    if (!r) return logMessage(e, `${window.location.hostname}\n${l(t, null, 2)}\nStack trace:\n${(new Error).stack}`, true), 
    t && "object" == typeof t && logMessage(e, t, true, false), t;
    try {
